...
export default function NewTransaction(){
    ...
    const {
        ...
        async function onSubmitForm(data) {
            try {
                const body = { ...data, type };  //...copia tudo, valor, descrição e tipo input
                await createNewTransaction(body);
                navigate("/");  //navega ou manda erro
                } catch (error) {
    ...
    return (
        <div className="flex flex-col items-center justify-around bg-zinc-900 rounded p-8 gap-7 relative">
            ...
            <form onSubmit={handleSubmit(onSubmitForm)} className="flex flex-col justify-center gap-4 w-full text-2xl">
